...
export const SEED_DECK: CardDef[] = [
  ...
  { id: 'alch:rebis', cls: 'symbol', name: 'The Rebis', text: 'The two-headed hermaphrodite: Sol and Luna conjoined into one body.', glyphs: ['sol', 'luna', 'mercurius'], correspondences: { stage: 'rubedo', pole: 'union' }, sourceRef: 'alchemical tradition' },
  { id: 'alch:nigredo', cls: 'concept', name: 'Nigredo', text: 'The blackening — putrefaction, the necessary death before rebirth.', glyphs: ['saturn'], correspondences: { stage: 'nigredo', planet: 'Saturn' }, sourceRef: 'alchemical tradition' },
  { id: 'alch:albedo', cls: 'concept', name: 'Albedo', text: 'The whitening — washing and purification under the Moon.', glyphs: ['luna'], correspondences: { stage: 'albedo', planet: 'Moon' }, sourceRef: 'alchemical tradition' },
  { id: 'alch:green-lion', cls: 'symbol', name: 'The Green Lion', text: 'Vitriol that devours the Sun; the solvent that opens fixed matter.', glyphs: ['venus', 'water'], correspondences: { planet: 'Venus' }, sourceRef: 'alchemical tradition' },
